...
function initClient() {
    ...
    if (!DetectRTC.isMobileDevice) {
        ...
        setTippy('stopRecordButton', 'Stop all recording.', 'right');
...
function whoAreYou() {
    ...
    Swal.fire({
        ...
        getPeerInfo();
        window.localStorage.peer_id = peer_info.peer_id;
        joinRoom(peer_name, room_id);
    });
...
async function shareRoom(useNavigator = false) {
    ...
    function share() {
        ...
        rc.socket.emit('registerRoomManager', peer_info);
...
function shareRoomByEmail() {
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const email = '';
            const emailSubject = `Please join our Pedagobox Video Chat Meeting`;
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'Do you want to rate your Pedagobox experience?',
...
function showAbout() {
    ...
    Swal.fire({
        ...
        <br/>
        <div id="about">
            Author: <a id="linkedin-button" data-umami-event="Linkedin button" href="" target="_blank"> Kateryna Z.</a>
        </div>
        `,
        showClass: { popup: 'animate__animated animate__fadeInDown' },
        hideClass: { popup: 'animate__animated animate__fadeOutUp' },
