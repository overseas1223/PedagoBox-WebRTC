...
```bash
# Clone this repo
$ git clone https://github.com/COCO-DEV03033/realtime-video-conf
# Go to to dir realtime-video-conf
$ cd realtime-video-conf
...
```bash
# Pedagobox SFU - HTTPS — proxy all requests to the Node app
server {
	# Enable HTTP/2
...
Check Your Pedagobox SFU instance: https://your.domain.name/

---

## Update script

In order to have always Your Pedagobox SFU updated to latest, we going to create a script
...
cd pedagoboxsfu
git pull
docker pull pedagobox/sfu:latest
docker-compose up -d
...
To update your instance of Pedagobox SFU at latest commit, execute:
